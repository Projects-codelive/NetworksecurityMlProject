...
# 3. Split data into strain and test
# 4. Save in ingested folder
import pandas as pd
...
class DataIngestion:
    ...
    def export_collection_as_dataframe(self):
        try:
            ...
            # While reading the data from mongodb by default _id is column is added to data
    ...
    def split_data_as_train_test(self,dataframe: pd.DataFrame):
        try:
            ...
            logging.info("Traion test split is done on dataframe")
